...
def main(num_factors, num_workers, num_iterations, beta_value, lambda_value, \
...
if __name__ == "__main__":
    if len(sys.argv) <> 9:
        ...
        print 'Usage: spark-submit %s <num_factors> <num_workers> \
                <num_iterations> <beta_value> <lambda_value> <V_filename> \
    ...
    MAXSEED = 100000
    # Start map reduce
    main(num_factors, num_workers, num_iterations, beta_value, lambda_value, \
            V_filename, output_W_filename, output_H_filename)
